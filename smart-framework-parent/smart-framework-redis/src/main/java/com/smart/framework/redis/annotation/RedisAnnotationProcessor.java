...
public class RedisAnnotationProcessor {
    ...
    public Object processDistributedLock(ProceedingJoinPoint joinPoint, com.smart.framework.redis.annotation.DistributedLock distributedLock) throws Throwable {
        String lockKey = parseSpEL(distributedLock.key(), joinPoint);
        
        try {
            com.smart.framework.redis.service.DistributedLock lock = distributedLockService.acquireLock(
                lockKey, 
