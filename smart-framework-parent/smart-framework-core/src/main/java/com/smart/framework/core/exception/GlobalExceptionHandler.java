...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Result<Void>> handleNoHandlerFoundException(NoResourceFoundException e, HttpServletRequest request) {
    ...
    public ResponseEntity<Result<Void>> handleException(Exception e, HttpServletRequest request) {
        ...
        if (e instanceof NoResourceFoundException) {
            return handleNoHandlerFoundException((NoResourceFoundException) e, request);
        }
