...
//     * @return 响应结果
//     */
//    public <T> doGet(String serviceName, String url, ParameterizedTypeReference<T> responseType) {
...
//     * @return 响应结果
//     */
//    public <T> T doGet(String serviceName, String url, HttpHeaders headers, ParameterizedTypeReference<T> responseType) {
//        try {
